...
bin/preprocess.py hdf5_to_image -i data/merged/heart_masks/320x320.h5 \
    -d X --nrow 20 --ncol 10 --resize 128,128 --margin 1 --margin-color 1 \
    -o tmp/preview/heart_masks.png
```
